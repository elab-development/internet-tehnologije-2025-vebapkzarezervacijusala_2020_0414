...
{/* User card */} <div className='rounded-2xl border bg-white p-6 shadow-sm'> <div className='flex items-start gap-4'> <div className='flex h-12 w-12 items-center justify-center rounded-xl bg-gray-900 text-white'> <User2 className='h-6 w-6' /> </div>
